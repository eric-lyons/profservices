...
def initialize(dev):
    ...
    sdk = looker_sdk.init40(base_url="https://master.dev.looker.com:19999")
    if dev == "True":
...
def main():
    ...
    Returns: None
    """
    parser = argparse.ArgumentParser(description='Identify schedule hotspots \
                                     and smooth by updating cron')
